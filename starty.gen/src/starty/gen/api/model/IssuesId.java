...
/**
 * IssuesId generated by hbm2java
 */
@Embeddable

public class IssuesId  implements java.io.Serializable {
    ...
    /** full constructor */
    public IssuesId(String id, String projectId) {
        this.id = id;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof IssuesId) ) return false;
		 IssuesId castOther = ( IssuesId ) other; 
